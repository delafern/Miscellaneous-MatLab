...
%% This was one of the first codes I wrote  - very proudly generated a plot resembling the mandelbrot set. 
%O bviously there are other coding languages which would be preferable for doing this in terms of speed and graphics handling.
